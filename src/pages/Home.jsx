      ...
      <section className="py-16 px-6 max-w-5xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="border rounded-xl p-8">
            ...
            <Link to="/signup">
              <button className="mt-6 bg-teal-700 text-white px-6 py-2 rounded-full hover:bg-teal-800">
                Get Started Free
              </button>
            </Link>
          </div>
      ...
      <footer className="bg-gray-900 text-white py-12 px-10">
        <div className="max-w-6xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-400 text-xs">Enterprise-grade education technology platform.</p>
          </div>
          {[
